...
// checks if the IscsiTestResultDetailRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IscsiTestResultDetailRest{}

// IscsiTestResultDetailRest struct for IscsiTestResultDetailRest
type IscsiTestResultDetailRest struct {
...
func NewIscsiTestResultDetailRest() *IscsiTestResultDetailRest {
	this := IscsiTestResultDetailRest{}
	return &this
}
...
func (o IscsiTestResultDetailRest) MarshalJSON() ([]byte, error) {
...
func (o IscsiTestResultDetailRest) ToMap() (map[string]interface{}, error) {
...
type NullableIscsiTestResultDetailRest struct {
	value *IscsiTestResultDetailRest
	isSet bool
}

func (v NullableIscsiTestResultDetailRest) Get() *IscsiTestResultDetailRest {
	return v.value
}

func (v *NullableIscsiTestResultDetailRest) Set(val *IscsiTestResultDetailRest) {
	v.value = val
	v.isSet = true
}

func (v NullableIscsiTestResultDetailRest) IsSet() bool {
	return v.isSet
}

func (v *NullableIscsiTestResultDetailRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIscsiTestResultDetailRest(val *IscsiTestResultDetailRest) *NullableIscsiTestResultDetailRest {
	return &NullableIscsiTestResultDetailRest{value: val, isSet: true}
}

func (v NullableIscsiTestResultDetailRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIscsiTestResultDetailRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
