...
// checks if the WorkflowItemRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowItemRest{}

// WorkflowItemRest struct for WorkflowItemRest
type WorkflowItemRest struct {
...
func (o WorkflowItemRest) MarshalJSON() ([]byte, error) {
...
func (o WorkflowItemRest) ToMap() (map[string]interface{}, error) {
...
type NullableWorkflowItemRest struct {
	value *WorkflowItemRest
	isSet bool
}

func (v NullableWorkflowItemRest) Get() *WorkflowItemRest {
	return v.value
}

func (v *NullableWorkflowItemRest) Set(val *WorkflowItemRest) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowItemRest) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowItemRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowItemRest(val *WorkflowItemRest) *NullableWorkflowItemRest {
	return &NullableWorkflowItemRest{value: val, isSet: true}
}

func (v NullableWorkflowItemRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowItemRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
