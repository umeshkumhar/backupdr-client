...
// checks if the MembershipChangeRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipChangeRest{}

// MembershipChangeRest struct for MembershipChangeRest
type MembershipChangeRest struct {
...
func (o MembershipChangeRest) MarshalJSON() ([]byte, error) {
...
func (o MembershipChangeRest) ToMap() (map[string]interface{}, error) {
...
type NullableMembershipChangeRest struct {
	value *MembershipChangeRest
	isSet bool
}

func (v NullableMembershipChangeRest) Get() *MembershipChangeRest {
	return v.value
}

func (v *NullableMembershipChangeRest) Set(val *MembershipChangeRest) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipChangeRest) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipChangeRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipChangeRest(val *MembershipChangeRest) *NullableMembershipChangeRest {
	return &NullableMembershipChangeRest{value: val, isSet: true}
}

func (v NullableMembershipChangeRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipChangeRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
