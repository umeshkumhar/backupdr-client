...
// checks if the FeatureFlagsRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureFlagsRest{}

// FeatureFlagsRest struct for FeatureFlagsRest
type FeatureFlagsRest struct {
	// feature value
...
func (o FeatureFlagsRest) MarshalJSON() ([]byte, error) {
...
func (o FeatureFlagsRest) ToMap() (map[string]interface{}, error) {
...
type NullableFeatureFlagsRest struct {
	value *FeatureFlagsRest
	isSet bool
}

func (v NullableFeatureFlagsRest) Get() *FeatureFlagsRest {
	return v.value
}

func (v *NullableFeatureFlagsRest) Set(val *FeatureFlagsRest) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatureFlagsRest) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatureFlagsRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatureFlagsRest(val *FeatureFlagsRest) *NullableFeatureFlagsRest {
	return &NullableFeatureFlagsRest{value: val, isSet: true}
}

func (v NullableFeatureFlagsRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatureFlagsRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
