...
type JobApiCountCombinedJobOpts struct {
    Filter optional.String
}

func (a *JobApiService) CountCombinedJob(ctx context.Context, localVarOptionals *JobApiCountCombinedJobOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/jobstatus"
...
type JobApiListCombinedJobsOpts struct {
...
func (a *JobApiService) ListCombinedJobs(ctx context.Context, localVarOptionals *JobApiListCombinedJobsOpts) (ListJobRest, *http.Response, error) {
	var (
