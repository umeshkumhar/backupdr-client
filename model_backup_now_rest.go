...
// checks if the BackupNowRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupNowRest{}

// BackupNowRest struct for BackupNowRest
type BackupNowRest struct {
...
func (o BackupNowRest) MarshalJSON() ([]byte, error) {
...
func (o BackupNowRest) ToMap() (map[string]interface{}, error) {
...
type NullableBackupNowRest struct {
	value *BackupNowRest
	isSet bool
}

func (v NullableBackupNowRest) Get() *BackupNowRest {
	return v.value
}

func (v *NullableBackupNowRest) Set(val *BackupNowRest) {
	v.value = val
	v.isSet = true
}

func (v NullableBackupNowRest) IsSet() bool {
	return v.isSet
}

func (v *NullableBackupNowRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackupNowRest(val *BackupNowRest) *NullableBackupNowRest {
	return &NullableBackupNowRest{value: val, isSet: true}
}

func (v NullableBackupNowRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackupNowRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
