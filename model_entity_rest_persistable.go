...
// checks if the EntityRestPersistable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityRestPersistable{}

// EntityRestPersistable Base class for REST objects
type EntityRestPersistable struct {
...
func (o EntityRestPersistable) MarshalJSON() ([]byte, error) {
...
func (o EntityRestPersistable) ToMap() (map[string]interface{}, error) {
...
type NullableEntityRestPersistable struct {
	value *EntityRestPersistable
	isSet bool
}

func (v NullableEntityRestPersistable) Get() *EntityRestPersistable {
	return v.value
}

func (v *NullableEntityRestPersistable) Set(val *EntityRestPersistable) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityRestPersistable) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityRestPersistable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityRestPersistable(val *EntityRestPersistable) *NullableEntityRestPersistable {
	return &NullableEntityRestPersistable{value: val, isSet: true}
}

func (v NullableEntityRestPersistable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityRestPersistable) UnmarshalJSON(src []byte) error {
	v.isSet = true
