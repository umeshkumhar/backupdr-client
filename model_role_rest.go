...
// checks if the RoleRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleRest{}

// RoleRest struct for RoleRest
...
func (o RoleRest) MarshalJSON() ([]byte, error) {
...
func (o RoleRest) ToMap() (map[string]interface{}, error) {
...
type NullableRoleRest struct {
	value *RoleRest
	isSet bool
}

func (v NullableRoleRest) Get() *RoleRest {
	return v.value
}

func (v *NullableRoleRest) Set(val *RoleRest) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleRest) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleRest(val *RoleRest) *NullableRoleRest {
	return &NullableRoleRest{value: val, isSet: true}
}

func (v NullableRoleRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
