...
// checks if the ScriptRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScriptRest{}

// ScriptRest struct for ScriptRest
...
func (o ScriptRest) MarshalJSON() ([]byte, error) {
...
func (o ScriptRest) ToMap() (map[string]interface{}, error) {
...
type NullableScriptRest struct {
	value *ScriptRest
	isSet bool
}

func (v NullableScriptRest) Get() *ScriptRest {
	return v.value
}

func (v *NullableScriptRest) Set(val *ScriptRest) {
	v.value = val
	v.isSet = true
}

func (v NullableScriptRest) IsSet() bool {
	return v.isSet
}

func (v *NullableScriptRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScriptRest(val *ScriptRest) *NullableScriptRest {
	return &NullableScriptRest{value: val, isSet: true}
}

func (v NullableScriptRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScriptRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
