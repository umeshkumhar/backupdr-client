...
// checks if the IAMPermissionsRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IAMPermissionsRest{}

// IAMPermissionsRest This object represents the results of IAM permission checks
type IAMPermissionsRest struct {
...
func (o IAMPermissionsRest) MarshalJSON() ([]byte, error) {
...
func (o IAMPermissionsRest) ToMap() (map[string]interface{}, error) {
...
type NullableIAMPermissionsRest struct {
	value *IAMPermissionsRest
	isSet bool
}

func (v NullableIAMPermissionsRest) Get() *IAMPermissionsRest {
	return v.value
}

func (v *NullableIAMPermissionsRest) Set(val *IAMPermissionsRest) {
	v.value = val
	v.isSet = true
}

func (v NullableIAMPermissionsRest) IsSet() bool {
	return v.isSet
}

func (v *NullableIAMPermissionsRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIAMPermissionsRest(val *IAMPermissionsRest) *NullableIAMPermissionsRest {
	return &NullableIAMPermissionsRest{value: val, isSet: true}
}

func (v NullableIAMPermissionsRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIAMPermissionsRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
