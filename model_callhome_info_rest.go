...
// checks if the CallhomeInfoRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallhomeInfoRest{}

// CallhomeInfoRest struct for CallhomeInfoRest
type CallhomeInfoRest struct {
...
func (o CallhomeInfoRest) MarshalJSON() ([]byte, error) {
...
func (o CallhomeInfoRest) ToMap() (map[string]interface{}, error) {
...
type NullableCallhomeInfoRest struct {
	value *CallhomeInfoRest
	isSet bool
}

func (v NullableCallhomeInfoRest) Get() *CallhomeInfoRest {
	return v.value
}

func (v *NullableCallhomeInfoRest) Set(val *CallhomeInfoRest) {
	v.value = val
	v.isSet = true
}

func (v NullableCallhomeInfoRest) IsSet() bool {
	return v.isSet
}

func (v *NullableCallhomeInfoRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallhomeInfoRest(val *CallhomeInfoRest) *NullableCallhomeInfoRest {
	return &NullableCallhomeInfoRest{value: val, isSet: true}
}

func (v NullableCallhomeInfoRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallhomeInfoRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
