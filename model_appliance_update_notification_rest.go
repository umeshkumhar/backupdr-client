...
// checks if the ApplianceUpdateNotificationRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceUpdateNotificationRest{}

// ApplianceUpdateNotificationRest struct for ApplianceUpdateNotificationRest
type ApplianceUpdateNotificationRest struct {
...
func NewApplianceUpdateNotificationRest() *ApplianceUpdateNotificationRest {
	this := ApplianceUpdateNotificationRest{}
	return &this
}
...
func (o ApplianceUpdateNotificationRest) MarshalJSON() ([]byte, error) {
...
func (o ApplianceUpdateNotificationRest) ToMap() (map[string]interface{}, error) {
...
type NullableApplianceUpdateNotificationRest struct {
	value *ApplianceUpdateNotificationRest
	isSet bool
}

func (v NullableApplianceUpdateNotificationRest) Get() *ApplianceUpdateNotificationRest {
	return v.value
}

func (v *NullableApplianceUpdateNotificationRest) Set(val *ApplianceUpdateNotificationRest) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceUpdateNotificationRest) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceUpdateNotificationRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceUpdateNotificationRest(val *ApplianceUpdateNotificationRest) *NullableApplianceUpdateNotificationRest {
	return &NullableApplianceUpdateNotificationRest{value: val, isSet: true}
}

func (v NullableApplianceUpdateNotificationRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceUpdateNotificationRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
