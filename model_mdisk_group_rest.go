...
// checks if the MdiskGroupRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MdiskGroupRest{}

// MdiskGroupRest struct for MdiskGroupRest
type MdiskGroupRest struct {
...
func (o MdiskGroupRest) MarshalJSON() ([]byte, error) {
...
func (o MdiskGroupRest) ToMap() (map[string]interface{}, error) {
...
type NullableMdiskGroupRest struct {
	value *MdiskGroupRest
	isSet bool
}

func (v NullableMdiskGroupRest) Get() *MdiskGroupRest {
	return v.value
}

func (v *NullableMdiskGroupRest) Set(val *MdiskGroupRest) {
	v.value = val
	v.isSet = true
}

func (v NullableMdiskGroupRest) IsSet() bool {
	return v.isSet
}

func (v *NullableMdiskGroupRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMdiskGroupRest(val *MdiskGroupRest) *NullableMdiskGroupRest {
	return &NullableMdiskGroupRest{value: val, isSet: true}
}

func (v NullableMdiskGroupRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMdiskGroupRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
