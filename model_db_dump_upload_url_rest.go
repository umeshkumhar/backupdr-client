...
// checks if the DbDumpUploadUrlRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbDumpUploadUrlRest{}

// DbDumpUploadUrlRest struct for DbDumpUploadUrlRest
type DbDumpUploadUrlRest struct {
	DbDumpUploadUrl *string `json:"dbDumpUploadUrl,omitempty"`
...
// GetDbDumpUploadUrl returns the DbDumpUploadUrl field value if set, zero value otherwise.
func (o *DbDumpUploadUrlRest) GetDbDumpUploadUrl() string {
	if o == nil || IsNil(o.DbDumpUploadUrl) {
		var ret string
		return ret
	}
	return *o.DbDumpUploadUrl
}

// GetDbDumpUploadUrlOk returns a tuple with the DbDumpUploadUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DbDumpUploadUrlRest) GetDbDumpUploadUrlOk() (*string, bool) {
	if o == nil || IsNil(o.DbDumpUploadUrl) {
		return nil, false
	}
	return o.DbDumpUploadUrl, true
}
...
// SetDbDumpUploadUrl gets a reference to the given string and assigns it to the DbDumpUploadUrl field.
...
func (o DbDumpUploadUrlRest) MarshalJSON() ([]byte, error) {
...
func (o DbDumpUploadUrlRest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DbDumpUploadUrl) {
		toSerialize["dbDumpUploadUrl"] = o.DbDumpUploadUrl
	}
	if !IsNil(o.DbName) {
...
type NullableDbDumpUploadUrlRest struct {
	value *DbDumpUploadUrlRest
	isSet bool
}

func (v NullableDbDumpUploadUrlRest) Get() *DbDumpUploadUrlRest {
	return v.value
}

func (v *NullableDbDumpUploadUrlRest) Set(val *DbDumpUploadUrlRest) {
	v.value = val
	v.isSet = true
}

func (v NullableDbDumpUploadUrlRest) IsSet() bool {
	return v.isSet
}

func (v *NullableDbDumpUploadUrlRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDbDumpUploadUrlRest(val *DbDumpUploadUrlRest) *NullableDbDumpUploadUrlRest {
	return &NullableDbDumpUploadUrlRest{value: val, isSet: true}
}

func (v NullableDbDumpUploadUrlRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDbDumpUploadUrlRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
