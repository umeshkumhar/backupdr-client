...
// checks if the LiveCloneRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LiveCloneRest{}

// LiveCloneRest struct for LiveCloneRest
type LiveCloneRest struct {
...
func (o LiveCloneRest) MarshalJSON() ([]byte, error) {
...
func (o LiveCloneRest) ToMap() (map[string]interface{}, error) {
...
type NullableLiveCloneRest struct {
	value *LiveCloneRest
	isSet bool
}

func (v NullableLiveCloneRest) Get() *LiveCloneRest {
	return v.value
}

func (v *NullableLiveCloneRest) Set(val *LiveCloneRest) {
	v.value = val
	v.isSet = true
}

func (v NullableLiveCloneRest) IsSet() bool {
	return v.isSet
}

func (v *NullableLiveCloneRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLiveCloneRest(val *LiveCloneRest) *NullableLiveCloneRest {
	return &NullableLiveCloneRest{value: val, isSet: true}
}

func (v NullableLiveCloneRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLiveCloneRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
