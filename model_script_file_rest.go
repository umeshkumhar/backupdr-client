...
// checks if the ScriptFileRest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScriptFileRest{}

// ScriptFileRest struct for ScriptFileRest
type ScriptFileRest struct {
...
func (o ScriptFileRest) MarshalJSON() ([]byte, error) {
...
func (o ScriptFileRest) ToMap() (map[string]interface{}, error) {
...
type NullableScriptFileRest struct {
	value *ScriptFileRest
	isSet bool
}

func (v NullableScriptFileRest) Get() *ScriptFileRest {
	return v.value
}

func (v *NullableScriptFileRest) Set(val *ScriptFileRest) {
	v.value = val
	v.isSet = true
}

func (v NullableScriptFileRest) IsSet() bool {
	return v.isSet
}

func (v *NullableScriptFileRest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScriptFileRest(val *ScriptFileRest) *NullableScriptFileRest {
	return &NullableScriptFileRest{value: val, isSet: true}
}

func (v NullableScriptFileRest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScriptFileRest) UnmarshalJSON(src []byte) error {
	v.isSet = true
