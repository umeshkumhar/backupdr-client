...
type StorageArrayApiCountArraysOpts struct {
    Filter optional.String
}

func (a *StorageArrayApiService) CountArrays(ctx context.Context, localVarOptionals *StorageArrayApiCountArraysOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/array"
...
type StorageArrayApiCreateArrayOpts struct {
    Body optional.Interface
}

func (a *StorageArrayApiService) CreateArray(ctx context.Context, localVarOptionals *StorageArrayApiCreateArrayOpts) (ArrayRest, *http.Response, error) {
	var (
...
type StorageArrayApiCredentialTestOpts struct {
    Body optional.Interface
}

func (a *StorageArrayApiService) CredentialTest(ctx context.Context, localVarOptionals *StorageArrayApiCredentialTestOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/array/pretest"
...
*/
func (a *StorageArrayApiService) DeleteArray(ctx context.Context, arrayId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/array/{array_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"array_id"+"}", fmt.Sprintf("%v", arrayId), -1)
...
@return ArrayRest
*/
func (a *StorageArrayApiService) GetArray(ctx context.Context, arrayId string) (ArrayRest, *http.Response, error) {
	var (
...
*/
func (a *StorageArrayApiService) GetArrayTypes(ctx context.Context) (ListArrayTypeRest, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/array/type"
...
type StorageArrayApiListArraysOpts struct {
...
func (a *StorageArrayApiService) ListArrays(ctx context.Context, localVarOptionals *StorageArrayApiListArraysOpts) (ListArrayRest, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *StorageArrayApiService) TestArray(ctx context.Context, arrayId string) (ListArrayTestResultRest, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
type StorageArrayApiUpdateArrayOpts struct {
    Body optional.Interface
}

func (a *StorageArrayApiService) UpdateArray(ctx context.Context, arrayId string, localVarOptionals *StorageArrayApiUpdateArrayOpts) (ArrayRest, *http.Response, error) {
	var (
